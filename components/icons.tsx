...
export const UsersIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.57-1.031 1.25-2.009 2.07-2.912V2.009L15 6.009V11m-6 .47c-.57-1.031-1.25-2.009-2.07-2.912V2.009L6 6.009V11.47M12 18.72a9.094 9.094 0 0 0-3.741-.479 3 3 0 0 0-4.682 2.72M12 18.72V11" />
  </svg>
);
